...
__all__ = ["CVLP_r50", "CVLP_vit16", "CVLP_r50_vid", "CVLP_vit_14L", "CVLP_r50_return_feat",
           "CVLP_r50_teacher", 'CVLP_vit_14L_336px']
...
class CVLP(nn.Module):
    ...
    def forward(self, x, train=True):
        ...
        image_features = image_features.reshape((num_batches, -1) + image_features.shape[1:]).mean(dim=1, keepdim=False)
...
@register_model
def CVLP_r50_teacher(pretrained=False, **kwargs):
    args = kwargs['args']
    setattr(args, "pretrained_clip", 'pretrained/RN50.pt')
...
@register_model
def CVLP_r50_return_feat(pretrained=False, **kwargs):
    args = kwargs['args']
...
@register_model
def CVLP_vit_14L(pretrained=False, **kwargs):
    args = kwargs['args']
...
@register_model
def CVLP_vit_14L_336px(pretrained=False, **kwargs):
    args = kwargs['args']
...
@register_model
def CVLP_r50_vid(pretrained=False, **kwargs):
    args = kwargs['args']
